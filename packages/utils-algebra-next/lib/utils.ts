...
export { Algebra } from '@comunica/utils-algebra';
type KnownOperation = Algebra.KnownOperation;
type Operation = Algebra.Operation;
 ...
 */
export const mapOperationStrict: typeof transformer.transformNode =
 ...
 * using a transformer that works its way back up from the descendant to the startObject.
 */
export const mapOperationSubStrict: typeof transformer.transformNodeSpecific =
 ...
 */
export const visitOperation: typeof transformer.visitNode =
  transformer.visitNode.bind(transformer);
 ...
 *     indicate the subType.
 */
export const visitOperationSub: typeof transformer.visitNodeSpecific =
  transformer.visitNodeSpecific.bind(transformer);
